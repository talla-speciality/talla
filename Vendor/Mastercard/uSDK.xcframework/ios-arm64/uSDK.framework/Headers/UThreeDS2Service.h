...
@class UTransaction, UWarning, UUiCustomization, UConfigParameters, UCreateTransactionSpec, UInitSpec, UAuthenticationSpec;
 ...
 */
- (void)initialize:(nonnull UConfigParameters *)configParameters
...
/**
 ...
 @param messageVersion The message version for the SDK. E.g. "2.2.0"
 ...
 */
- (BOOL)cleanup:(NSError *__autoreleasing  _Nullable *_Nullable)error;
...
/**
 ...
 @return SDK version
 */
- (nullable NSString *)getSDKVersion:(NSError *__autoreleasing  _Nullable *_Nullable)error;
 ...
 */
- (nullable NSArray<UWarning *> *)getWarnings:(NSError *__autoreleasing  _Nullable *_Nullable)error;
