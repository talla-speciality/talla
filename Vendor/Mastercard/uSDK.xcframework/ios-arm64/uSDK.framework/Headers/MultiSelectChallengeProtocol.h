...
//
//  MultiSeletChallengeProtocol.h
//  ThreeDSSDK
//
//  Created by Drew Pitchford on 9/28/17.
...
- (void)selectIndex:(NSInteger)index NS_SWIFT_NAME(selectIndex(_:));
- (void)clickSubmitAuthenticationLabel;
