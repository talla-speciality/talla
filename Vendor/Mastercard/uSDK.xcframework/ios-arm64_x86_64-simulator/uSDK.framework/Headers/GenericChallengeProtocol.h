...
- (void)setChallengeProtocolWithSdkChallengeProtocol:(id <SDKChallengeProtocol> _Nonnull)sdkChallengeProtocol NS_SWIFT_NAME(setChallengeProtocol(sdkChallengeProtocol:));
- (void)expandTextsBeforeScreenshot;
- (void)selectWhitelistCheckedWithChecked:(BOOL)checked NS_SWIFT_NAME(selectWhitelistChecked(checked:));
- (void)selectDeviceBindingCheckedWithChecked:(BOOL)checked NS_SWIFT_NAME(selectDeviceBindingChecked(checked:));
- (void)setLandscapeOrientation:(BOOL)landscapeOrientation NS_SWIFT_NAME(setLandscapeOrientation(landscapeOrientation:));
