...
enum AppLocalization {
    private static let translations: [String: [String: String]] = [
        ...
        ,"secure_checkout_handoff": ["ar": "ادفع بأمان عبر Shopify، ثم ارجع إلى Talla لتتبع الطلب وBeans."]
        ,"secure_payment": ["ar": "دفع آمن"]
        ,"payment_methods": ["ar": "طرق الدفع"]
        ,"payment_methods_detail": ["ar": "ادفع باستخدام Apple Pay أو البطاقة عبر Shopify. لا تحفظ Talla تفاصيل بطاقتك."]
