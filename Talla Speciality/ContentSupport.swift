...
enum AppLocalization {
    private static let translations: [String: [String: String]] = [
        ...
        "payment_click_to_pay_subtitle": ["ar": "استخدم بطاقاتك المحفوظة للدفع بشكل أسرع"],
        "payment_click_to_pay_sheet_subtitle": ["ar": "استخدم البطاقات المحفوظة والمدعومة للدفع بشكل أسرع"],
        "payment_click_to_pay_supporting": ["ar": "متاح للبطاقات المدعومة من فيزا وماستركارد وأمريكان إكسبريس."],
        "payment_click_to_pay_guidance": ["ar": "اختر هذا الخيار للوصول إلى بطاقاتك المؤهلة المحفوظة في Click to Pay."],
        "payment_benefit_action": ["ar": "متابعة إلى بنفت"],
        "payment_card_action": ["ar": "إدخال بيانات البطاقة"],
        "payment_click_to_pay_action": ["ar": "المتابعة عبر Click to Pay"],
