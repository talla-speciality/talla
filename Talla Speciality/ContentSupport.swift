...
enum AppLocalization {
    private static let translations: [String: [String: String]] = [
        ...
        ,"delivery_reminders_subtitle": ["ar": "العناوين، وتنبيهات عودة التوفر، والسلال المحفوظة لإعادة الطلب بسرعة."]
        ...
        ,"secure_checkout_handoff": ["ar": "ادفع بأمان في Shopify، ثم ارجع إلى Talla لعرض حالة الطلب وBeans."]
        ,"payment_methods": ["ar": "طرق الدفع"]
        ,"payment_methods_detail": ["ar": "يتم الدفع بالبطاقات وApple Pay بأمان داخل Shopify Checkout. لا تحفظ Talla أرقام البطاقات داخل التطبيق."]
